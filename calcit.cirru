...
{}
  :configs $ {} (:reload-fn |app.main/reload!) (:port 6001) (:output |src) (:storage-key |calcit.cirru) (:version |0.1.9-a5)
                                            ...
                                            :data $ {}
                                              ...
                                              |j $ {}
                                                :data $ {}
                                                  ...
                                                  |v $ {}
                                                    :data $ {}
                                                      |j $ {} (:text |ip/address) (:type :leaf) (:at 1629196722131) (:by |rJG4IHzWf) (:id |4C1-6kMfHLM)
                                                    :type :expr
                                                    :at 1596987799470
                                                    :by |rJG4IHzWf
                                                    :id |rBAseaFwzrL
